...
function CreateRequestAction(fetchAction, recieveAction, errorAction, sideEffect) {
    return function () {
        ...
        return function (dispatch) {
            dispatch((0, _reduxActions.createAction)(fetchAction)());
            return sideEffect.apply(undefined, args).then(function (data) {
                return Promise.resolve(dispatch((0, _reduxActions.createAction)(recieveAction)(data)));
            }, function (error) {
                return dispatch((0, _reduxActions.createAction)(errorAction)(error));
            });
        };
    };
}