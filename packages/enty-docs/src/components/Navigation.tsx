...
function Navigation(props: Props): Node {
    const api = (
        <NavigationLink to="/api/enty/entity-schema" textStyle="navigationLink">
            Api
        </NavigationLink>
    );
    const tutorial = (
        <NavigationLink to="/guides/getting-started" textStyle="navigationLink">
            Guides
        </NavigationLink>
    );
    const logo = (
        <NavigationLink to="/" textStyle="navigationLink">
            <Flex>
                <Box>
                    <img src={Logo} height="24px" alt="Enty" />
                </Box>
                <Box ml={2}>Enty</Box>
            </Flex>
        </NavigationLink>
