...
export default function Provider(props: Props): Node {
    ...
    const mdxComponents = {
        ...
        h1: ({children: id}) => (
            <Text as="h1" textStyle="h1" mb={3} id={anchor(id)} children={id} />
        ),
        h2: ({children: id}) => (
            <Text as="h2" textStyle="h2" pt={4} mb={3} id={anchor(id)} children={id} />
        ),
        h3: ({children: id}) => (
            <Text as="h3" textStyle="h3" pt={4} mb={3} id={anchor(id)} children={id} />
        ),
